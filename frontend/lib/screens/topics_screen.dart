...
class _TopicsScreenState extends State<TopicsScreen> {
  ...
  late List<Topic> _subjectTopics;

  @override
  void initState() {
    super.initState();
    _subjectTopics = _topicsRepository.getTopicsBySubjectId(widget.subject.id);
  }
  ...
  void _addTopic(String name) {
    ...
    final newTopic = Topic(
      id: _subjectTopics.length + 1,
      subjectId: widget.subject.id,
      name: name,
      createdAt: DateTime.now(),
    );
    setState(() {
      _topicsRepository.addTopic(newTopic);
      _subjectTopics = _topicsRepository.getTopicsBySubjectId(
        widget.subject.id,
      );
    });
